...
![Uncertainty/disorder of strucutres in Mol*](hiv_uncertainty.png)
...
>Note: I am unsure why the sse function is not working using an existing PDB file as my reference protein :(
...
![Color by Occupancy in Mol*](hiv_conserve.png)